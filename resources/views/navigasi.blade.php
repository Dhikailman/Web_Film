...
<div class="w-full bg-white h-[96px] drop-shadow-lg flex flex-row items-center ">
    ...
    <a href="" class="uppercase text-base mx-5 text-black font-inter hover:text-develobe-700 duration-200 font-bold">Movies</a>
    <a href="" class="uppercase text-base mx-5 text-black font-inter hover:text-develobe-700 duration-200 font-bold">TV Show</a>
</div>
    <div class="w-1/3 flex items-center justify-center">
    <a href="" class="font-bold text-5xl font-quicksand text-develobe-900  hover:text-black duration-200 font-bold ">CINEMA XXI</a>
</div>
